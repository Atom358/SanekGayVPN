...
2) По возможности не направляйте через VPN трафик к ресурсам, которые и так входят в «белый список» оператора, — это аномалия, привлекающая внимание. В клиенте установите режим обхода для выбранных приложений (раздельное туннелирование), исключив банки, госуслуги, маркетплейсы и подобные российские приложения.
